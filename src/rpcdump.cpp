...
UniValue bip38encrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("bip38encrypt", "\"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\" \"mypasphrase\"") +
            HelpExampleRpc("bip38encrypt", "\"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\" \"mypasphrase\""));
...
UniValue bip38decrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38decrypt \"saddress\" \"passphrase\"\n"
