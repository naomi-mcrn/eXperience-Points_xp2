...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "  \"isstaking\" : true|false,       (boolean) If the address is a staking address for cold staking -only if is standard address-\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("validateaddress", "\"PTAgVppXHdbHgrowoagtwc5Y4zaqbVUJV5\"") +
            HelpExampleCli("validateaddress", "\"sapling_address\"") +
            HelpExampleRpc("validateaddress", "\"PTAgVppXHdbHgrowoagtwc5Y4zaqbVUJV5\""));
...
UniValue createmultisig(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            HelpExampleCli("createmultisig", "2 \"[\\\"PTAgVppXHdbHgrowoagtwc5Y4zaqbVUJV5\\\",\\\"PTwzSGpnSSRG5KX8sF9V8hP45Ej47bWS3p\\\"]\"") +
            "\nAs a json rpc call\n" +
            HelpExampleRpc("createmultisig", "2 \"[\\\"PTAgVppXHdbHgrowoagtwc5Y4zaqbVUJV5\\\",\\\"PTwzSGpnSSRG5KX8sF9V8hP45Ej47bWS3p\\\"]\""));
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            HelpExampleCli("signmessage", "\"PTAgVppXHdbHgrowoagtwc5Y4zaqbVUJV5\" \"my message\"") +
            "\nVerify the signature\n" +
            HelpExampleCli("verifymessage", "\"PTAgVppXHdbHgrowoagtwc5Y4zaqbVUJV5\" \"signature\" \"my message\"") +
            "\nAs json rpc\n" +
            HelpExampleRpc("verifymessage", "\"PTAgVppXHdbHgrowoagtwc5Y4zaqbVUJV5\", \"signature\", \"my message\""));
