...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total balance of the wallet in XP (excluding zerocoins)\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("validateaddress", "\"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\"") + HelpExampleRpc("validateaddress", "\"PXUaUNWYdQeHAkshWKfnSfMAWx99eDAVnn\""));
