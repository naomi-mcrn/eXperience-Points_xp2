...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("setaccount", "\"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\" \"tabby\"") + HelpExampleRpc("setaccount", "\"PXUaUNWYdQeHAkshWKfnSfMAWx99eDAVnn\", \"tabby\""));
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("getaccount", "\"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\"") + HelpExampleRpc("getaccount", "\"PXUaUNWYdQeHAkshWKfnSfMAWx99eDAVnn\""));
...
UniValue movecmd(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 3 || params.size() > 5)
        throw std::runtime_error(
            ...
            "3. amount            (numeric, required) Amount in XP to move between accounts.\n"
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw std::runtime_error(
            ...
            HelpExampleCli("sendmany", "\"tabby\" \"{\\\"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\\\":0.01,\\\"DAD3Y6ivr8nPQLT1NEPX84DxGCw9jz9Jvg\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n" +
            HelpExampleCli("sendmany", "\"tabby\" \"{\\\"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\\\":0.01,\\\"DAD3Y6ivr8nPQLT1NEPX84DxGCw9jz9Jvg\\\":0.02}\" 6 \"testing\"") +
            "\nAs a json rpc call\n" +
            HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\\\":0.01,\\\"DAD3Y6ivr8nPQLT1NEPX84DxGCw9jz9Jvg\\\":0.02}\", 6, \"testing\""));
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw std::runtime_error(
            ...
            HelpExampleCli("addmultisigaddress", "2 \"[\\\"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\\\",\\\"DAD3Y6ivr8nPQLT1NEPX84DxGCw9jz9Jvg\\\"]\"") +
            "\nAs json rpc call\n" +
            HelpExampleRpc("addmultisigaddress", "2, \"[\\\"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\\\",\\\"DAD3Y6ivr8nPQLT1NEPX84DxGCw9jz9Jvg\\\"]\""));
...
UniValue walletlock(const UniValue& params, bool fHelp)
{
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw std::runtime_error(
            ...
            HelpExampleCli("sendtoaddress", "\"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\" 1.0") +
...
UniValue getwalletinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total balance of the wallet in XP\n"
...
UniValue autocombinerewards(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || (fEnable && params.size() != 2) || params.size() > 2)
        throw std::runtime_error(
            ...
            "\nWallet will automatically monitor for any coins with value below the threshold amount, and combine them if they reside with the same eXperience Points address\n"
...
UniValue multisend(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw std::runtime_error(
            ...
            "multisend <eXperience Points Address> <percent>\n"
    ...
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid eXperience Points address");
...
UniValue mintzerocoin(const UniValue& params, bool fHelp)
{
    ...
    if (Params().NetworkID() != CBaseChainParams::REGTEST)
        throw JSONRPCError(RPC_WALLET_ERROR, "zXP minting is DISABLED");
...
UniValue spendzerocoin(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 4 || params.size() < 3)
        throw std::runtime_error(
            ...
            "\nSpend zXP to a eXperience Points address.\n" +
            HelpRequiringPassphrase() + "\n"
            ...
            HelpExampleRpc("spendzerocoin", "5000 false true \"PXUaUNWYdQeHAkshWKfnSfMAWx99eDAVnn\""));
    ...
    if (fMintChange && Params().NetworkID() != CBaseChainParams::REGTEST)
        throw JSONRPCError(RPC_WALLET_ERROR, "zXP minting is DISABLED, cannot mint change");
    ...
    if (!ispublicspend && Params().NetworkID() != CBaseChainParams::REGTEST) {
        throw JSONRPCError(RPC_WALLET_ERROR, "zXP old spend only available in regtest for tests purposes");
    }
...
UniValue spendzerocoinmints(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw std::runtime_error(
            ...
            "\nSpend zXP mints to a eXperience Points address.\n" +
            HelpRequiringPassphrase() + "\n"
            ...
            HelpExampleRpc("spendzerocoinmints", "[\"0d8c16eee7737e3cc1e4e70dc006634182b175e039700931283b202715a0818f\", \"dfe585659e265e6a509d93effb906d3d2a0ac2fe3464b2c3b6d71a3ef34c8ad7\"], \"PXUaUNWYdQeHAkshWKfnSfMAWx99eDAVnn\""));
