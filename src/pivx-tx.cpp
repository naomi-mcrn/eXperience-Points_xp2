...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("eXperience Points Core eXperiencePoints-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  eXperiencePoints-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded eXperience Points transaction") + "\n" +
                               "  eXperiencePoints-tx [options] -create [commands]   " + _("Create hex-encoded eXperience Points transaction") + "\n" +
                               "\n";
